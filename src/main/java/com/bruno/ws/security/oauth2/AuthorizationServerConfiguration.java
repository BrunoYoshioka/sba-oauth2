package com.bruno.ws.security.oauth2;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    private TokenStore tokenStore = new InMemoryTokenStore(); // para salvar os tokens em memória
    ...
    public void configure(ClientDetailsServiceConfigurer clients ) throws Exception {
        clients.inMemory()
                ...
                .scopes("bar", "read", "write") // (registros de endereços de base), ler e escrever
                .resourceIds(this.RESOURCE_ID)
                .accessTokenValiditySeconds(60)
                .refreshTokenValiditySeconds(60*60*24); // 24h de validade do token
    }
